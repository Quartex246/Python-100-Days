...
prev: [[Day01-20/07.分支和循环结构实战.md]]
next: [[Day01-20/09.常用数据结构之列表-2.md]]
---
## 常用数据结构之列表-1
...
- 列表——通过容器型变量存储多个数据
- 格式：变量名 = [元素1，元素2]
- 可以运算，+为将两个列表中的元素并到同一个列表中，* 为将列表中的元素重复几遍
- 索引运算：在方括号中放入元素序号（元素从0开始），可以从负数开始算
- start:end:stride格式：起始元素：结束元素：隔多少个元素
- 
